...
import (
	...
	st "pc3r-tme4/client/structures" // contient la structure Personne
...
func newPersonneEmp() *personne_emp {
	return &personne_emp{statut: "V"}
}

func (p *personne_emp) initialise() {
	strPersonne := lecteur()
	personne := personne_de_ligne(strPersonne)
	p.Personne = personne
	//Insere un nombre aleatoire de function de travail entre 1 et 5
	nbFonctions := rand.Intn(5) + 1
